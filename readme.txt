...
= 0.1.35 =
* Fix: `QrDownloadController` ripulito da duplicato accidentale in coda (parse error) dopo 0.1.34.

= 0.1.34 =
* Fix: rimosso codice duplicato in `AdminMenu.php` (errore di sintassi in admin) e corretta stringa "qualità".
