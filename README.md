...
- **Guida AI integrata**: pulsante "Guida AI" nell'header del CPT editor che apre un modale con linee guida editoriali (HTML sicuro, IT+EN, divieto claim salutistici, ecc.) e prompt template copiabili separati per Storia, Sentori, Abbinamenti, Note di servizio. Pronti da incollare in ChatGPT/Claude per generare i testi.
